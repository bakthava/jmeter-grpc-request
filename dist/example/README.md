...
- Then copy the latest version [jmeter-grpc-request](https://github.com/bakthava/jmeter-grpc-request/releases) to the *lib/ext* directory of JMeter and restart JMeter.
